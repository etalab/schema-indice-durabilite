...
- d'un fichier csv déjà existant. (vous pouvez partir de [ce fichier exemple](https://github.com/etalab/schema-indice-durabilite/blob/main/televiseur/exemple-valide.csv)).
- d'un formulaire
...
## Voir aussi
- [Exemple valide](https://github.com/etalab/schema-indice-durabilite/blob/main/televiseur/exemple-valide.csv)
